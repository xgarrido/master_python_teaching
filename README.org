#+TITLE:  Python courses of Master 1 - README
#+AUTHOR: Xavier Garrido

* Introduction

This repository contains materials for Python lectures given in Master 1 of Fundamental Physics at
the University of Paris Sud. It provides slides and exercices to give an introduction of Python
programming.
...
#+BEGIN_SRC latex
  ...
  \setbeamertemplate{frametitle}{%
    ...
    \vskip+3pt\color{gray!75}\footnotesize\faHandORight\xspace\insertframesubtitle\par\fi}
...
| + | 07_td_matplotlib2   | Librairie <code>matplotlib</code> (2<sup>ème</sup> partie)  |
|---+---------------------+-------------------------------------------------------------|
...
#+BEGIN_SRC shell :tangle no :results output
  ...
  cvs_version="<i class=\"fab fa-github-alt\"></i> version control - ${cvs_version}"
  echo ${cvs_version}
#+END_SRC
