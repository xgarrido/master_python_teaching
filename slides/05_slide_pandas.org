...
* =pandas.Series= : création & parcours
  ...
  #+ATTR_LATEX: :options fontsize=\scriptsize
  #+BEGIN_SRC python
    In [1]: population_dict = {"California": 38_332_521,
                               "Texas": 26_448_193,
                               "New York": 19_651_127,
                               "Florida": 19_552_860,
                               "Illinois": 12_882_135}
...
- L'objet =DataFrame= généralise la déclaration de *tableau =numpy= à 2 dimensions* en associant à la fois un
  ...
  #+ATTR_LATEX: :options fontsize=\scriptsize
  #+BEGIN_SRC python
    In [6]: area_dict = {"California": 423_967, "Texas": 695_662, "New York": 141_297,
...
- Il existe pléthore de ressources sur internet
  - documentation officielle de [[https://pandas.pydata.org/pandas-docs/stable/pandas.pdf][=pandas=]] ($\gtrsim$ 3000 pages !)
