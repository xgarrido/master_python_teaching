...
#+AUTHOR: Adrien La Posta & Xavier Garrido
#+DATE:   14/01/2017
#+OPTIONS: toc:nil ^:{}
#+STARTUP:     beamer
...
- Cours $\lesssim$ 1 heure, lundi ou mercredi (amphi. A6) à partir de 15h45
...
- Examen (2 heures) *sur machine* : session anonyme mais accès à l'ensemble des ressources du cours
  (transparents, TD corrigés, annales)
