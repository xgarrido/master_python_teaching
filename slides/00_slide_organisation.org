...
#+AUTHOR: Jade Pasté & Xavier Garrido
#+DATE:   14/01/2017
#+OPTIONS: toc:nil ^:{}
#+STARTUP: beamer
...
- Bases de la programmation en Python (2 séances)
  ...
  - type de données, bloc conditionnel, boucles =for=, /containers/
  - fonctions, scripts & modules
...
- Cours $\lesssim$ 1 heure, lundi ou mercredi (amphi. A1 ou amphi A5) à partir de 15h45
...
- *Mardi 13 Janvier de 15h à 17h* : Examen *sur machine*, session anonyme mais accès à l'ensemble des
  ressources du cours (transparents, TD corrigés, annales)

* Contacts \faIcon{address-book}

- Jade Pasté [[mailto:jade.paste@universite-paris-saclay.fr][*jade.paste@universite-paris-saclay.fr*]]
