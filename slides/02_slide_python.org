...
- Pour le remplacement de sous-chaînes, on tirera profit de la méthode =replace=
  ...
  #+BEGIN_SRC python
    In [1]: citation = "Chuck Norris a déjà compté jusqu'à l'infini. Deux fois."
    In [2]: citation = citation.replace("Chuck Norris", "Bruno Espagnon")
  #+END_SRC
...
- Utilisation de la méthode =format=[fn:14f65e5336818de0]
  ...
  #+BEGIN_SRC python
    ...
    In [2]: canevas.format(2025)
    Out[2]: "L'année 2025 s'écrit 11111101001 en binaire et 7e9 en héxadécimal"
  #+END_SRC
* Les chaînes de caractères
...
#+BEAMER: \pause
#+BEGIN_REMARK
À la différence des chaînes de caractères, les listes sont des objets _mutables_ /i.e./ modifiables !
#+END_REMARK
...
- Ajout & suppression d'éléments
  #+BEGIN_SRC python
    ...
    In [2]: kebab.append("frites") # équivalent à kebab += ["frites"]
    In [3]: kebab
