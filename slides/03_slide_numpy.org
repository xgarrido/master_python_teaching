...
* COMMENT Opérations algébriques
...
* COMMENT Opérations algébriques : intermède graphique
...
* COMMENT Sélection par masque : intermède graphique
** Python code
:PROPERTIES:
:BEAMER_COL: 0.55
:END:
...
* COMMENT Opérations diverses : concaténation
...
* COMMENT Entrées/sorties de =numpy=
